...
import com.modoop.core.util.ExceptionUtils;
import com.modoop.core.util.ReflectionUtils;
...
/**
 * 使用 Jaxb2.0 实现 XML<->Java Object 的 Mapper.
 * <p/>
 * 在创建时需要设定所有需要序列化的 Root 对象的 Class.
 * 特别支持 Root 对象是 Collection 的情形.
 */
